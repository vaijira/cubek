...
mod simple_cyclic {
    use super::*;
    type Algorithm = cubek_matmul::routines::simple::SimpleAlgorithm<TMM>;
...
mod simple_strided {
    use super::*;
    type Algorithm = cubek_matmul::routines::simple::SimpleAlgorithm<
        TMM,
...
mod simple_barrier_cooperative {
    use super::*;
    type Algorithm = cubek_matmul::routines::simple::SimpleBarrierAlgorithm<
        TMM,
...
mod double_buffering_cyclic {
    use super::*;
    type Algorithm = cubek_matmul::routines::double_buffering::CyclicDoubleBufferingAlgorithm<TMM>;
...
mod double_buffering_tilewise {
    use super::*;
    type Algorithm =
        cubek_matmul::routines::layered::double_buffering::TilewiseDoubleBufferingAlgorithm<TMM>;
...
mod double_buffering_hybrid {
    use super::*;
    type Algorithm =
        cubek_matmul::routines::layered::double_buffering::HybridDoubleBufferingAlgorithm<TMM>;
...
mod ordered_double_buffering {
    ...
    type Algorithm =
        cubek_matmul::routines::ordered_double_buffering::OrderedDoubleBufferingAlgorithm<TMM>;
...
mod specialized_cyclic {
    ...
    type Algorithm = cubek_matmul::routines::specialized::SpecializedAlgorithm<
        TMM,
